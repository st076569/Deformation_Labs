...
y_1 = round(y_1 * 10^5, 2);
y_2 = round(y_2 * 10^5, 2);
y_3 = round(y_3 * 10^5, 2);
theta_1 = round(theta_1 * 10^3, 2);
theta_3 = round(theta_3 * 10^3, 2);
delta_y_1 = round(delta_y_1 * 10^5, 2);
delta_theta_1 = round(delta_theta_1 * 10^3, 2);
